    ...
    <>
      ...
      <main className="px-[24px] my-10">
        <div className="flex gap-2 md:gap-6 flex-col md:grid md:grid-cols-10 w-full h-full">
          <div className="flex gap-2 flex-col md:flex-1 md:w-auto col-span-5 2xl">
        ...
        <div className="grid md:grid-cols-10">
          <div className="hidden md:block md:col-span-2 border-2 lg:col-span-1 border-green-500">
            left
          </div>
          <article className="md:col-span-8 lg:col-span-6 border-sky-950 border-2">
          ...
          <div className="md:col-span-10 lg:col-span-3 border-amber-400 border-2">
